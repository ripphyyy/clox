...
Color primaryColor = const Color(0xff00ADB6);
Color secondaryColor = const Color(0xff00ADB5);
Color alertColor = const Color(0xffED6363);
Color priceColor = const Color(0xff2C96F1);
Color backgroundColor1 = const Color(0xff191919);
Color backgroundColor2 = const Color(0xff1F1D2B);
Color backgroundColor3 = const Color(0xff393E46);
Color backgroundColor4 = const Color(0xff252836);
Color backgroundColor5 = const Color(0xffEEEEEE);
